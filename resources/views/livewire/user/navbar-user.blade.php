        ...
        <div class="flex items-center md:order-2">
            ...
            <div class="hidden z-50 my-4 text-base list-none w-44 rounded divide-y divide-gray-100 shadow" id="dropdown">
                ...
                <ul class="py-1 bg-black" aria-labelledby="dropdown">
                    <li>
                        <a href="/userProfile" class="block py-2 px-4 text-sm text-white hover:bg-gray-100">My Profile</a>
                    </li>
                    <li>
                        <button type="button" class="block py-2 px-4 text-sm text-white hover:bg-gray-100" data-modal-toggle="logout">Logout</button>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="relative bg-zinc-800 rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('logout.logout') }}" method="POST">
                ...
                <div class="p-6 text-center">
                    ...
                    <button data-modal-toggle="logout" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Yes, I'm sure
                    </button>
                    <button data-modal-toggle="logout"  class="text-white bg-gray-500 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10">No, cancel</button>
                </div>
            </form>
        </div>
    </div>
