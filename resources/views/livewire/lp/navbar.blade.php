<nav class="border-b border-gray-600 px-2 sm:px-4 py-3 bg-zinc-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto px-10">
        ...
        <div class="flex md:order-2">
            <button type="button" class="text-white bg-gray-400 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 transition duration-150 ease-in-out" data-modal-toggle="login">Login</button>
                        ...
                        <div class="flex flex-col md:flex-row rounded-r-xl">
                            ...
                            <div class="flex flex-col md:w-96 first-letter:md:w-96">
                                ...
                                <div class="flex flex-col">
                                    <a href="#" class="text-sm text-center text-white underline p-5 hover:text-blue-500">Forget Password?</a>
