        ...
        <div class="relative p-4 w-full h-full md:h-auto">
            ...
            <div class="relative rounded-lg shadow ">
                ...
                <div class="p-6 space-y-6 bg-black">
                    ...
                    <form action="{{route('absenExam.absenExam')}}" method="POST">
                        @csrf
                    ...
                    <div class="flex flex-col mt-10">
                        ...
                        <a href="{{route('detailExam.detailExam', ['course'=>$exam->course_id, 'id'=>$exam->id])}}" class="text-center text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Cancel</a>
                    </div>
                    </form>
                </div>
            </div>
