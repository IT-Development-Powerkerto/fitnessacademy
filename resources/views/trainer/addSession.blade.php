                    ...
                    <div class="mb-6 repeater" id="group_a">
                        <div data-repeater-list="group_a">
                            <div data-repeater-item="" class="flex flex-row gap-4">
                                <input type="file" id="file" name="file" value="{{old('file')}}" class="bg-gray-50 rounded-lg border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full mt-6" placeholder="Image Trainer" required>
